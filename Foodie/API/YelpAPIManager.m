...
- (void)getRestaurantDetail:(Restaurant *)restaurant completion:(void (^)(NSArray *restautantDetail, NSError *error))completion {
    NSString *APIKey = @"28Yo8kD_K-RyBUR6gCWznPYoMh1ItVdboaEExmr9duOBklai0I21Ww6b-IHLW2ZJyn6Ohh70J_V-xP6Mxv1JV1V8HZ_9hljzdgqkMbouw6oRsY3f12VS0KL3LqHoYHYx";
    ...
    [[session dataTaskWithRequest:request
        ...
        if (!error) {
            ...
            NSDictionary *dictionary = responseDictionary;
            NSArray *restaurantDetail = [RestaurantDetail detailsWithDictionaries:dictionary];
